...
# Menu bar
    ...
    # Options
       ...
       # color_theme.add_command(label='Mkbhd',command=self.MKBHD)
        ...
        help_option.add_command(label="About CB_shop", command=self.msg)
        help_option.add_command(label="About Us", command=self.about)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("CB_shop",'CB_shop is a chatbot for answering your question about our shop\nIt is based on retrival-based NLP using pythons NLTK tool-kit module\nGUI is based on Tkinter')

    def about(self):
        tkinter.messagebox.showinfo("About Us","CB_shop\n\nMerisa Syafrina\nPradipta Budi Harimawan\nMaulana Muhammad Gibran\nBilly Andrian\nAlvin Tendio")
